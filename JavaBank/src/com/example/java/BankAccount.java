...
public class BankAccount {
    double accountNumber; // TODO want to use this as id key.
    double accounBalance;// TODO Want a class that has the money containers
    private String customerName;//TODO Want a customer info section

    public BankAccount(int i, int i1) {
